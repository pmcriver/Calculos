...
namespace Calculos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double t1 = ConversaoTemperatura(Conversoes.ConverterTemperatura.CelsiusFahrenheit, 36);
            double t2 = ConversaoTemperatura(Conversoes.ConverterTemperatura.FahrenheitCelsius, 100);
